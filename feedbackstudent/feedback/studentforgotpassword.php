...
if (isset($_POST['btnsubmit'])) {
    $sql = "SELECT * FROM student WHERE email_id='$_POST[email]' and status='Active'";
    ...
    if (mysqli_num_rows($qsql) >= 1) {
		...
		// Visit Link - <b><a href='$url/feedbackstudent/feedback/studentresetpassword.php?resetid=$_SESSION[resetid]&id=$rspro[0]'>Click here</a></b><br>
		// ";
		
	    $to = $_POST['email'];
        $subject = "KJSIT STAKEHOLDERS FEEDBACK ANALYSIS PORTAL PASSWORD RESET LINK";
        
        
        $message = "Dear $rspro[studentname],<br>
            <br>
            ...
            <br><br>
            Reset Password:<b><a href='$url/new/feedbackstudent/feedback/studentresetpassword.php?resetid=$_SESSION[resetid]&id=$rspro[0]'>Click here</a></b>
            <br><br>
        ...
        // sendmail($rspro['email_id'], $rspro['studentname'], "Password Recovery Mail", $message);
            ...
            <div class="container">
                ...
                <div class="forms">
                    <div class="form login">
                        <p class="login-box-msg" style="text-transform:uppercase"><b>Recover password</b></p>
