...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_affected_rows($con) == 1) {
        ...
        $to = $_POST['email_id'];
        $subject = "KJSIT STAKEHOLDERS FEEDBACK ANALYSIS PORTAL EMAIL ACTIVATION";

        
        //     $message = "Welcome $_POST[studentname],<br>
        // Click the following link to verify your email: <a href='$url/feedbackstudent/feedback/studentemailverify.php?code=$verificationCode'>Verify Email</a>";
        $message = "Dear $_POST[studentname],<br><br>
...
<br><br>
<a href='$url/new/feedbackstudent/feedback/studentemailverify.php?code=$verificationCode'>Verify Account</a>
<br><br>
...
KJSIT Stakeholders Feedback Analysis Team.";
        ...
        // sendmail($_POST['email_id'], $_POST['studentname'], "Account Verification for KJSIT Stakeholders Feedback System", $message);

        $sql = "UPDATE `student` SET verification_code='" . $verificationCode . "' WHERE `email_id`='" . $_POST['email_id'] . "'";
        mysqli_query($con, $sql);

        //echo "<script>alert('Please check your registed email for to verify your account in the Student Feedback Portal. Thank you.');</script>";
...
<head>
    ...
    <title>Student Feedback - Student Registration Window</title>
...
<body>
    ...
    <div class="main">
        ...
        <div class="heading">
            ...
            <h1 style="font-weight: bold; margin-bottom:0px ">Student Registration</h1>
        </div>
                    ...
                    <form method="post" action="" onsubmit="return confirmvalidation()" enctype="multipart/form-data"
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" name="studentname" id="studentname"
                                placeholder="Enter Your Full Name (First-Name Middle-Name Surname)" value="<?php if (isset($rsedit['studentname'])) {
    echo $rsedit['studentname'];
}?>">
                            <span id="studentnameError" class="error" style="display: none;"></span>
                        </div>
                        <br>
                        <div class="col-12">
                            <label for="inputRollNo" class="form-label">Roll No.</label>
                            <input type="number" class="form-control" name="rollno" min="1" max="100"  id="rollno"
                                placeholder="Please enter Your Class ROLL NO. and NOT YOUR STUDENT ID NUMBER" value="<?php if (isset($rsedit['rollno'])) {
    echo $rsedit['rollno'];
}?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="email" class="form-control" name="email_id"
                                placeholder="Enter Your Somaiya Email Id" id="email_id" value="<?php if (isset($rsedit['email_id'])) {
    echo $rsedit['email_id'];
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="mothers_no" maxlength="10"
                                placeholder="Mother Contact" id="mothers_no" value="<?php if (isset($rsedit['mothers_no'])) {
    echo $rsedit['mothers_no'];
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="fathers_no" maxlength="10"
                                placeholder="Father Contact" id="fathers_no" value="<?php if (isset($rsedit['fathers_no'])) {
    echo $rsedit['fathers_no'];
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="student_no" maxlength="10"
                                placeholder="Student Contact" id="student_no" value="<?php if (isset($rsedit['student_no'])) {
    echo $rsedit['student_no'];
}?>">
                            <span id="studentsnoError" class="error" style="display: none;"></span>
                        </div>
                        <br>
                        <div class="col-md-12">
                            <label for="inputContact" class="form-label">Password</label>
                            <input type="password" class="form-control" name="password"
                                placeholder="Enter Your Password" id="password" autocomplete="new-password" value="<?php if (isset($rsedit['password'])) {
    echo $rsedit['password'];
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="password" class="form-control" name="confirmpassword"
                                placeholder="Confirm Your Password" id="confirmpassword" value="<?php if (isset($rsedit['password'])) {
    echo $rsedit['password'];
}?>">
...
?>
    ...
    <footer>
        <div class="footer-content">
            ...
            <a href="../../aboutus.php" style="color:white !important">
                ...
                <h6>Developed by : Dakshita Kolte, Kapil Bhatia and Palak Desai</h6>
            </a>
        </div>
    </footer>
    <!-- jQuery -->
    ...
    document.getElementById('studentsnoError').textContent = '';
    document.getElementById('studentsnoError').style.display = 'none';
    ...
    function confirmvalidation() {
        ...
        if (document.getElementById('studentname').value === '') {
            ...
            isValid = false;
        } else if (document.getElementById('student_no').value === '') {
            fieldValidation();
            document.getElementById('student_no').focus();
            document.getElementById('student_no').scrollIntoView({
                behavior: 'smooth'
            });
            isValid = false;
        } else if (!document.getElementById('student_no').value.match(phoneRegexOnlyNo)) {
            fieldValidation();
            document.getElementById('student_no').focus();
            document.getElementById('student_no').scrollIntoView({
                behavior: 'smooth'
            ...
            isValid = false;
        } else if (!document.getElementById('student_no').value.match(phoneRegexMax10Degit)) {
            fieldValidation();
            document.getElementById('student_no').focus();
            document.getElementById('student_no').scrollIntoView({
                behavior: 'smooth'
    ...
    function validateStudentname() {
        if (document.getElementById('studentname').value === '') {
            document.getElementById('studentnameError').textContent = 'Original Name should not be empty.';
    ...
    function validateRollno() {
        ...
        } else if (isNaN(rollno) || rollno < 1 || rollno > 100) {
            rollnoError.textContent = 'Roll no must be a number between 1 and 100';
    ...
    function validateStudentNo() {
        if (document.getElementById('student_no').value === '') {
            document.getElementById('studentsnoError').textContent = 'Student No should not be empty';
            document.getElementById('studentsnoError').style.display = 'block';
        } else if (!document.getElementById('student_no').value.match(phoneRegexOnlyNo)) {
            document.getElementById('studentsnoError').textContent =
                'Please enter a valid phone number (digits and + only).';
            document.getElementById('studentsnoError').style.display = 'block';
        } else if (!document.getElementById('student_no').value.match(phoneRegexMax10Degit)) {
            document.getElementById('studentsnoError').textContent = 'Please enter a valid 10-digit phone number.';
            document.getElementById('studentsnoError').style.display = 'block';
        } else {
            document.getElementById('studentsnoError').textContent = '';
            document.getElementById('studentsnoError').style.display = 'none';
    ...
    document.getElementById('studentname').addEventListener('change', validateStudentname);
    ...
    document.getElementById('student_no').addEventListener('change', validateStudentNo);
