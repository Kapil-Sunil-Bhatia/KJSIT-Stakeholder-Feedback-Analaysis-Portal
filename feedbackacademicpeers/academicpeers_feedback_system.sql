...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 28, 2023 at 07:40 AM
...
--
-- Database: `academicpeers_feedback_system`
--
...
(6, 4, '11', '1', '2', '', '', '', '', '', '', '', '', 'Check Box', '173576919', 'Active');
...
INSERT INTO `feedbackquestion_result` (`feedbackquestion_resultid`, `feedbacktopicid`, `peersid`, `date`, `feedbackquestionid`, `selectedanswer`, `course_id`) VALUES
...
(4, 0, 0, '', 0, 'test', '2023-06-27 17:53:04', '1134286024', '', 'eeeee', 'Approved');
...
CREATE TABLE `peers` (
  ...
  `peers_no` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `status` varchar(10) NOT NULL,
  `is_verified` tinyint(4) NOT NULL,
  `verification_code` varchar(191) NOT NULL,
  `teachingexp` int(11) DEFAULT NULL,
  `subtaught` int(11) DEFAULT NULL,
...
INSERT INTO `peers` (`peersid`, `peersname`, `email_id`, `colname`, `password`, `course_id`, `dateofbirth`, `academicyear`, `peers_no`, `status`, `is_verified`, `verification_code`, `teachingexp`, `subtaught`, `designation`, `research`) VALUES
(6, 'Dakshita', 'd.kolte@somaiya.edu', '', 'Admin@123', 1, '2002-10-31', '2022-23', '5555555555', 'Active', 0, '', 11, 11, 'Assistant Professor', ''),
(17, 'qwerty', 'palak.pd@somaiya.edu', '', 'Admin@123', 3, '2003-12-10', '2022-23', '2222222222', 'Active', 0, '', 12, 12, 'Assistant Professor', ''),
(25, 'kapil', 'kapil.bhatia@somaiya.edu', '1122aaa', 'Admin@123', 0, '1111-11-11', '2022-23', '1111111111', 'Active', 0, '', 11, 11, 'Assistant Professor', ''),
(26, 'aaaa', 'apil.hatia@somaiya.edu', 'qqqqqqqqq', 'Admin@123', 0, '1111-11-11', '2022-23', '1111111111', 'Active', 0, '', 11, 11, 'qqqqqqqqqqqqqqq', ''),
(27, 'qq', 'ksbcell12@gmail.com', 'aaaaa', 'Admin@123', 0, '1111-11-11', '2022-23', '1111111111', 'Active', 0, '', 111, 1111111, 'aaaaa', 'qqqqq');
...
--
ALTER TABLE `feedbacktopic`
  MODIFY `feedbacktopicid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `peers`
--
ALTER TABLE `peers`
  MODIFY `peersid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
COMMIT;
