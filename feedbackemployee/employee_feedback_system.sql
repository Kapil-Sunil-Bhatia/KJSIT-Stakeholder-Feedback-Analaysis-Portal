...
CREATE TABLE `employee` (
  ...
  `employee_no` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `status` varchar(10) NOT NULL,
...
INSERT INTO `employee` (`employeeid`, `employeename`, `email_id`, `orgname`, `password`, `course_id`, `dateofbirth`, `academicyear`, `employee_no`, `status`, `is_verified`, `verification_code`, `teachingexp`, `industryexp`, `designation`) VALUES
...
(25, 'kapil', 'kapil.bhatia@somaiya.edu', '1122aaa', 'Admin@123', 4, '1111-11-11', '2022-23', '1111111111', 'Active', 0, '', 11, 11, 'Assistant Professor');
...
INSERT INTO `feedbackquestion_result` (`feedbackquestion_resultid`, `feedbacktopicid`, `employeeid`, `date`, `feedbackquestionid`, `selectedanswer`) VALUES
